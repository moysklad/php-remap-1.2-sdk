...
| ------------- | ------------- | ------------- |
| [**createGroup()**](GroupsApi.md#createGroup) | **POST** /entity/group | Создать группу |
| [**deleteGroup()**](GroupsApi.md#deleteGroup) | **DELETE** /entity/group/{id} | Удалить группу |
| [**getGroupById()**](GroupsApi.md#getGroupById) | **GET** /entity/group/{id} | Получить группу по ID |
| [**getGroups()**](GroupsApi.md#getGroups) | **GET** /entity/group | Получить список групп |
| [**updateGroup()**](GroupsApi.md#updateGroup) | **PUT** /entity/group/{id} | Обновить группу |


## `createGroup()`

```php
createGroup($group, $expand, $accept, $accept_encoding, $content_type): \OpenAPI\Client\Model\Group
```
...
$group = new \OpenAPI\Client\Model\Group(); // \OpenAPI\Client\Model\Group
...
try {
    $result = $apiInstance->createGroup($group, $expand, $accept, $accept_encoding, $content_type);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **group** | [**\OpenAPI\Client\Model\Group**](../Model/Group.md)|  | |
...
```php
deleteGroup($id, $accept, $accept_encoding)
```
...
try {
    $apiInstance->deleteGroup($id, $accept, $accept_encoding);
} catch (Exception $e) {
...
```php
getGroupById($id, $expand, $accept, $accept_encoding): \OpenAPI\Client\Model\Group
```
...
try {
    $result = $apiInstance->getGroupById($id, $expand, $accept, $accept_encoding);
    print_r($result);
} catch (Exception $e) {
...
```php
getGroups($limit, $offset, $search, $filter, $expand, $order, $accept, $accept_encoding): \OpenAPI\Client\Model\GroupList
```
...
try {
    $result = $apiInstance->getGroups($limit, $offset, $search, $filter, $expand, $order, $accept, $accept_encoding);
    print_r($result);
} catch (Exception $e) {
...
```php
updateGroup($id, $group, $expand, $accept, $accept_encoding, $content_type): \OpenAPI\Client\Model\Group
```
...
try {
    $result = $apiInstance->updateGroup($id, $group, $expand, $accept, $accept_encoding, $content_type);
    print_r($result);
} catch (Exception $e) {
