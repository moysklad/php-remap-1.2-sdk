...
**transaction_type** | **string** | Тип бонусной операции. Известные значения описаны в TransactionType | [optional]
**transaction_status** | **string** | Статус бонусной операции. Известные значения описаны в TransactionStatus | [optional] [readonly]
**category_type** | **string** | Категория бонусной операции. Известные значения описаны в CategoryType | [optional] [readonly]
