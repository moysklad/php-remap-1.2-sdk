...
/**
 * AddProductImagesRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddProductImagesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addProductImages_request';
    ...
    */
    ...
    public function setFilename($filename)
    {
        ...
        if ((mb_strlen($filename) > 255)) {
            throw new \InvalidArgumentException('invalid length for $filename when calling AddProductImagesRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets content
     *
     * @param string $content Файл, закодированный в формате Base64
     *
     * @return self
     */
