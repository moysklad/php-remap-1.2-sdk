    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Assortment., must be smaller than or equal to 255.');
        }
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Assortment., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling Assortment., must be smaller than or equal to 255.');
        }
    ...
    public function setArticle($article)
    {
        ...
        if ((mb_strlen($article) > 255)) {
            throw new \InvalidArgumentException('invalid length for $article when calling Assortment., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Assortment., must be smaller than or equal to 4096.');
        }
    ...
    public function setTnved($tnved)
    {
        ...
        if ((mb_strlen($tnved) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tnved when calling Assortment., must be smaller than or equal to 255.');
        }
