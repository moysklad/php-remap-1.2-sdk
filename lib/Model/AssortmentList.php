...
/**
 * AssortmentList Class Doc Comment
 *
 * @category Class
 * @description Список ассортимента
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssortmentList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssortmentList';
    ...
    protected static $openAPITypes = [
        ...
        'rows' => '\OpenAPI\Client\Model\Assortment[]'
    ];
    ...
    */
     ...
     * Sets rows
     *
     * @param \OpenAPI\Client\Model\Assortment[]|null $rows Массив элементов ассортимента
     *
     * @return self
     */
