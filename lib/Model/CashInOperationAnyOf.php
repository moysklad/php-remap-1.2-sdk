...
/**
 * CashInOperationAnyOf Class Doc Comment
 *
 * @category Class
 * @description Заказ покупателя + linkedSum
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CashInOperationAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashInOperation_anyOf';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID Заказа покупателя
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Наименование Заказа покупателя
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CashInOperationAnyOf., must be smaller than or equal to 255.');
        }
     ...
     * Sets code
     *
     * @param string|null $code Код Заказа покупателя
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CashInOperationAnyOf., must be smaller than or equal to 255.');
        }
     ...
     * Sets external_code
     *
     * @param string|null $external_code Внешний код Заказа покупателя
     *
     * @return self
     */
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling CashInOperationAnyOf., must be smaller than or equal to 255.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Комментарий Заказа покупателя
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CashInOperationAnyOf., must be smaller than or equal to 4096.');
        }
     ...
     * Sets deleted
     *
     * @param string|null $deleted Момент последнего удаления Заказа покупателя
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param string|null $updated Момент последнего обновления Заказа покупателя
     *
     * @return self
     */
     ...
     * Sets sum
     *
     * @param float|null $sum Сумма Заказа в установленной валюте
     *
     * @return self
     */
     ...
     * Gets positions
     *
     * @return \OpenAPI\Client\Model\CustomerOrderPositionList|null
     */
     ...
     * Sets positions
     *
     * @param \OpenAPI\Client\Model\CustomerOrderPositionList|null $positions positions
     *
     * @return self
     */
    ...
    public function setShipmentAddress($shipment_address)
    {
        ...
        if (!is_null($shipment_address) && (mb_strlen($shipment_address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shipment_address when calling CashInOperationAnyOf., must be smaller than or equal to 255.');
        }
