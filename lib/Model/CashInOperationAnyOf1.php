...
/**
 * CashInOperationAnyOf1 Class Doc Comment
 *
 * @category Class
 * @description Возврат поставщику + linkedSum
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CashInOperationAnyOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashInOperation_anyOf_1';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID возврата поставщику
     *
     * @return self
     */
