...
/**
 * CashOutOperationAnyOf Class Doc Comment
 *
 * @category Class
 * @description Возврат покупателя + linkedSum
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CashOutOperationAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashOutOperation_anyOf';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID возврата покупателя
     *
     * @return self
     */
