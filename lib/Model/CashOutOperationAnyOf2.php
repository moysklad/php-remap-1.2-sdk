...
/**
 * CashOutOperationAnyOf2 Class Doc Comment
 *
 * @category Class
 * @description Счет поставщика + linkedSum
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CashOutOperationAnyOf2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashOutOperation_anyOf_2';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID Счета поставщика
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Наименование Счета поставщика
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CashOutOperationAnyOf2., must be smaller than or equal to 255.');
        }
     ...
     * Sets code
     *
     * @param string|null $code Код Счета поставщика
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CashOutOperationAnyOf2., must be smaller than or equal to 255.');
        }
     ...
     * Sets external_code
     *
     * @param string|null $external_code Внешний код Счета поставщика
     *
     * @return self
     */
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling CashOutOperationAnyOf2., must be smaller than or equal to 255.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Комментарий Счета поставщика
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CashOutOperationAnyOf2., must be smaller than or equal to 4096.');
        }
     ...
     * Sets deleted
     *
     * @param string|null $deleted Момент последнего удаления Счета поставщика
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param string|null $updated Момент последнего обновления Счета поставщика
     *
     * @return self
     */
