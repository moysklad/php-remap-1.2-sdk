...
/**
 * CashOutOperationAnyOf4 Class Doc Comment
 *
 * @category Class
 * @description Выданный отчет комиссионера + linkedSum
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CashOutOperationAnyOf4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashOutOperation_anyOf_4';
