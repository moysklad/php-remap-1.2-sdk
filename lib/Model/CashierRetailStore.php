...
/**
 * CashierRetailStore Class Doc Comment
 *
 * @category Class
 * @description Метаданные точки продаж, к которой прикреплен кассир
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CashierRetailStore implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cashier_retailStore';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CashierRetailStore., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CashierRetailStore., must be smaller than or equal to 4096.');
        }
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address when calling CashierRetailStore., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling CashierRetailStore., must be smaller than or equal to 255.');
        }
    ...
    public function setDemandPrefix($demand_prefix)
    {
        ...
        if ((mb_strlen($demand_prefix) > 255)) {
            throw new \InvalidArgumentException('invalid length for $demand_prefix when calling CashierRetailStore., must be smaller than or equal to 255.');
        }
    ...
    public function setQrTerminalId($qr_terminal_id)
    {
        ...
        if ((mb_strlen($qr_terminal_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $qr_terminal_id when calling CashierRetailStore., must be smaller than or equal to 255.');
        }
    ...
    public function setIdQr($id_qr)
    {
        ...
        if ((mb_strlen($id_qr) > 255)) {
            throw new \InvalidArgumentException('invalid length for $id_qr when calling CashierRetailStore., must be smaller than or equal to 255.');
        }
