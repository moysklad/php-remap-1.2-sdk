...
/**
 * CommissionReportInPosition Class Doc Comment
 *
 * @category Class
 * @description Позиция реализовано комиссионером Полученного отчета комиссионера
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CommissionReportInPosition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    public static function createWithMeta(string $parentId, string $id) : CommissionReportInPosition {
        $o = new CommissionReportInPosition();
        $config = \OpenAPI\Client\Configuration::getDefaultConfiguration();
        $meta = new Meta();
        $meta->setType('commissionreportinposition');
        $href = $config->getHost() . '/' . 'entity' . '/' . 'commissionreportin' . '/' . $parentId . '/' . 'positions' . '/' . $id;
        $meta->setHref($href);
        $o->setMeta($meta);
        $o->setId($id);
        return $o;
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommissionReportInPosition';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID позиции
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity Количество товаров/услуг в позиции
     *
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity <= 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CommissionReportInPosition., must be bigger than 0.');
        }
     ...
     * Sets price
     *
     * @param float|null $price Цена товара в копейках
     *
     * @return self
     */
     ...
     * Sets reward
     *
     * @param float|null $reward Вознаграждение
     *
     * @return self
     */
     ...
     * Sets vat
     *
     * @param int|null $vat НДС для позиции
     *
     * @return self
     */
     ...
     * Sets vat_enabled
     *
     * @param bool|null $vat_enabled Включен ли НДС для позиции
     *
     * @return self
     */
     ...
     * Sets pack
     *
     * @param \OpenAPI\Client\Model\Pack|null $pack Упаковка Товара
     *
     * @return self
     */
