...
/**
 * CommissionReportOut Class Doc Comment
 *
 * @category Class
 * @description Выданный отчет комиссионера (commissionreportout). Заглушка: полное описание сущности в спецификации отсутствует; в ответе API возможны дополнительные поля.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CommissionReportOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommissionReportOut';
