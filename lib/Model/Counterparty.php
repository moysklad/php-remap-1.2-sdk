...
class Counterparty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'legal_address_full' => '\OpenAPI\Client\Model\Address',
        'inn' => 'string',
        'kpp' => 'string',
        'ogrn' => 'string',
        'ogrnip' => 'string',
    ...
    protected static $setters = [
        ...
        'legal_address_full' => 'setLegalAddressFull',
        'inn' => 'setInn',
        'kpp' => 'setKpp',
        'ogrn' => 'setOgrn',
        'ogrnip' => 'setOgrnip',
    ...
    protected static $getters = [
        ...
        'legal_address_full' => 'getLegalAddressFull',
        'inn' => 'getInn',
        'kpp' => 'getKpp',
        'ogrn' => 'getOgrn',
        'ogrnip' => 'getOgrnip',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('legal_address_full', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets legal_address_full
     *
     * @return \OpenAPI\Client\Model\Address|null
     */
    public function getLegalAddressFull()
    {
        return $this->container['legal_address_full'];
    }

    /**
     * Sets legal_address_full
     *
     * @param \OpenAPI\Client\Model\Address|null $legal_address_full Полный юридический адрес контрагента
     *
     * @return self
     */
    public function setLegalAddressFull($legal_address_full)
    {
        if (is_null($legal_address_full)) {
            array_push($this->openAPINullablesSetToNull, 'legal_address_full');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('legal_address_full', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['legal_address_full'] = $legal_address_full;
     ...
     * Gets discounts
     *
     * @return \OpenAPI\Client\Model\AgentDiscount[]|null
     */
     ...
     * Sets discounts
     *
     * @param \OpenAPI\Client\Model\AgentDiscount[]|null $discounts Массив скидок контрагента
     *
     * @return self
     */
    ...
    public function setBonusProgram($bonus_program)
    {
        if (is_null($bonus_program)) {
            array_push($this->openAPINullablesSetToNull, 'bonus_program');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bonus_program', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setPriceType($price_type)
    {
        if (is_null($price_type)) {
            array_push($this->openAPINullablesSetToNull, 'price_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('price_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
