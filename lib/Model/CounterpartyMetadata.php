...
/**
 * CounterpartyMetadata Class Doc Comment
 *
 * @category Class
 * @description Метаданные контрагентов
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CounterpartyMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CounterpartyMetadata';
    ...
    */
     ...
     * Sets tags
     *
     * @param string[]|null $tags Тэги контрагентов
     *
     * @return self
     */
     ...
     * Sets create_shared
     *
     * @param bool|null $create_shared Создавать новых контрагентов с меткой \"Общий\"
     *
     * @return self
     */
