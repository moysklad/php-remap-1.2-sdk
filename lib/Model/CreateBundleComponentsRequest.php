...
/**
 * CreateBundleComponentsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateBundleComponentsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createBundleComponents_request';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID компонента комплекта
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity Количество товаров/услуг/модификаций данного вида в компоненте
     *
     * @return self
     */
