...
/**
 * CreateCommissionReportInPositions200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateCommissionReportInPositions200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createCommissionReportInPositions_200_response_inner';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity <= 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreateCommissionReportInPositions200ResponseInner., must be bigger than 0.');
        }
