...
/**
 * CreateCommissionReportInPositionsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateCommissionReportInPositionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createCommissionReportInPositions_request';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity <= 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreateCommissionReportInPositionsRequest., must be bigger than 0.');
        }
