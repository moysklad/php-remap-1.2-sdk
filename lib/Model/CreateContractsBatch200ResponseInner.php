...
/**
 * CreateContractsBatch200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateContractsBatch200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createContractsBatch_200_response_inner';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateContractsBatch200ResponseInner., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateContractsBatch200ResponseInner., must be smaller than or equal to 4096.');
        }
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CreateContractsBatch200ResponseInner., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling CreateContractsBatch200ResponseInner., must be smaller than or equal to 255.');
        }
    ...
    public function setRewardPercent($reward_percent)
    {
        ...
        if (($reward_percent > 100)) {
            throw new \InvalidArgumentException('invalid value for $reward_percent when calling CreateContractsBatch200ResponseInner., must be smaller than or equal to 100.');
        }
        if (($reward_percent < 0)) {
            throw new \InvalidArgumentException('invalid value for $reward_percent when calling CreateContractsBatch200ResponseInner., must be bigger than or equal to 0.');
        }
