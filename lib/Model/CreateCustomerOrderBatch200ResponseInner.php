...
/**
 * CreateCustomerOrderBatch200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateCustomerOrderBatch200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createCustomerOrderBatch_200_response_inner';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateCustomerOrderBatch200ResponseInner., must be smaller than or equal to 255.');
        }
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CreateCustomerOrderBatch200ResponseInner., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling CreateCustomerOrderBatch200ResponseInner., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateCustomerOrderBatch200ResponseInner., must be smaller than or equal to 4096.');
        }
    ...
    public function setShipmentAddress($shipment_address)
    {
        ...
        if (!is_null($shipment_address) && (mb_strlen($shipment_address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shipment_address when calling CreateCustomerOrderBatch200ResponseInner., must be smaller than or equal to 255.');
        }
