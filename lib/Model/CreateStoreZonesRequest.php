...
/**
 * CreateStoreZonesRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateStoreZonesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createStoreZones_request';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID Зоны склада
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Наименование Зоны склада
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateStoreZonesRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets external_code
     *
     * @param string|null $external_code Внешний код Зоны склада
     *
     * @return self
     */
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling CreateStoreZonesRequest., must be smaller than or equal to 255.');
        }
