...
/**
 * CurrencyMajorUnit Class Doc Comment
 *
 * @category Class
 ...
 */
class CurrencyMajorUnit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Currency_majorUnit';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('s1', $data ?? [], null);
        $this->setIfExists('s2', $data ?? [], null);
        $this->setIfExists('s5', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets s1
     *
     * @param string|null $s1 Форма единицы, используемая при числительном 1
     *
     * @return self
     */
    ...
    {
        if (is_null($s1)) {
            throw new \InvalidArgumentException('non-nullable s1 cannot be null');
        }
     ...
     * Sets s2
     *
     * @param string|null $s2 Форма единицы, используемая при числительном 2
     *
     * @return self
     */
    ...
    {
        if (is_null($s2)) {
            throw new \InvalidArgumentException('non-nullable s2 cannot be null');
        }
     ...
     * Sets s5
     *
     * @param string|null $s5 Форма единицы, используемая при числительном 5
     *
     * @return self
     */
    ...
    {
        if (is_null($s5)) {
            throw new \InvalidArgumentException('non-nullable s5 cannot be null');
        }
