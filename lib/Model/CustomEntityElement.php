...
/**
 * CustomEntityElement Class Doc Comment
 *
 * @category Class
 * @description Элемент пользовательского справочника (customentity)
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomEntityElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomEntityElement';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID элемента пользовательского справочника
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param string|null $updated Момент последнего обновления элемента
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Наименование элемента пользовательского справочника
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomEntityElement., must be smaller than or equal to 255.');
        }
     ...
     * Sets code
     *
     * @param string|null $code Код элемента пользовательского справочника
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CustomEntityElement., must be smaller than or equal to 255.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Описание элемента пользовательского справочника
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CustomEntityElement., must be smaller than or equal to 4096.');
        }
     ...
     * Sets external_code
     *
     * @param string|null $external_code Внешний код элемента пользовательского справочника
     *
     * @return self
     */
    public function setExternalCode($external_code)
    {
        if (is_null($external_code)) {
            array_push($this->openAPINullablesSetToNull, 'external_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('external_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($external_code) && (mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling CustomEntityElement., must be smaller than or equal to 255.');
        }
