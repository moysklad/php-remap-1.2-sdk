...
class CustomerOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public static function createWithMeta(string $id) : CustomerOrder {
        $o = new CustomerOrder();
        $config = \OpenAPI\Client\Configuration::getDefaultConfiguration();
        $meta = new Meta();
        $meta->setType('customerorder');
        $href = $config->getHost() . '/' . 'entity' . '/' . 'customerorder' . '/' . $id;
        $meta->setHref($href);
        $o->setMeta($meta);
        $o->setId($id);
        return $o;
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomerOrder., must be smaller than or equal to 255.');
        }
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CustomerOrder., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling CustomerOrder., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CustomerOrder., must be smaller than or equal to 4096.');
        }
     ...
     * Sets positions
     *
     * @param \OpenAPI\Client\Model\CustomerOrderPositionList|null $positions Позиций Заказа покупателя
     *
     * @return self
     */
    ...
    public function setShipmentAddress($shipment_address)
    {
        ...
        if (!is_null($shipment_address) && (mb_strlen($shipment_address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shipment_address when calling CustomerOrder., must be smaller than or equal to 255.');
        }
