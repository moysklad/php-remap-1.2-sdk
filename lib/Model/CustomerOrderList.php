...
/**
 * CustomerOrderList Class Doc Comment
 *
 * @category Class
 * @description Список Заказов покупателей
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomerOrderList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerOrderList';
    ...
    protected static $openAPITypes = [
        ...
        'rows' => '\OpenAPI\Client\Model\CustomerOrder[]'
    ];
    ...
    */
     ...
     * Sets rows
     *
     * @param \OpenAPI\Client\Model\CustomerOrder[]|null $rows Массив Заказов покупателей
     *
     * @return self
     */
