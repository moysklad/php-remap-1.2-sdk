...
/**
 * CustomerOrderPaymentsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomerOrderPaymentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerOrder_payments_inner';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomerOrderPaymentsInner., must be smaller than or equal to 255.');
        }
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CustomerOrderPaymentsInner., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling CustomerOrderPaymentsInner., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CustomerOrderPaymentsInner., must be smaller than or equal to 4096.');
        }
    ...
    public function setPaymentPurpose($payment_purpose)
    {
        ...
        if ((mb_strlen($payment_purpose) > 255)) {
            throw new \InvalidArgumentException('invalid length for $payment_purpose when calling CustomerOrderPaymentsInner., must be smaller than or equal to 255.');
        }
