...
/**
 * DiscountAssortmentItem Class Doc Comment
 *
 * @category Class
 * @description Элемент массива assortment в скидках: метаданные товара, услуги или модификации. В JSON API в &#x60;meta.type&#x60; встречаются &#x60;product&#x60;, &#x60;service&#x60;, &#x60;variant&#x60; (см. документацию по скидкам).
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DiscountAssortmentItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DiscountAssortmentItem';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DiscountAssortmentItem., must be smaller than or equal to 255.');
        }
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $code when calling DiscountAssortmentItem., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling DiscountAssortmentItem., must be smaller than or equal to 255.');
        }
    ...
    public function setArticle($article)
    {
        ...
        if ((mb_strlen($article) > 255)) {
            throw new \InvalidArgumentException('invalid length for $article when calling DiscountAssortmentItem., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling DiscountAssortmentItem., must be smaller than or equal to 4096.');
        }
    ...
    public function setVat($vat)
    {
        ...
        if (($vat > 99)) {
            throw new \InvalidArgumentException('invalid value for $vat when calling DiscountAssortmentItem., must be smaller than or equal to 99.');
        }
        if (($vat < 0)) {
            throw new \InvalidArgumentException('invalid value for $vat when calling DiscountAssortmentItem., must be bigger than or equal to 0.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling DiscountAssortmentItem., must be bigger than or equal to 0.');
        }
    ...
    public function setVolume($volume)
    {
        ...
        if (($volume < 0)) {
            throw new \InvalidArgumentException('invalid value for $volume when calling DiscountAssortmentItem., must be bigger than or equal to 0.');
        }
    ...
    public function setTnved($tnved)
    {
        ...
        if ((mb_strlen($tnved) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tnved when calling DiscountAssortmentItem., must be smaller than or equal to 255.');
        }
