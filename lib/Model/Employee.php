    ...
    */
    ...
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling Employee., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Employee., must be smaller than or equal to 4096.');
        }
    ...
    public function setMiddleName($middle_name)
    {
        ...
        if ((mb_strlen($middle_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling Employee., must be smaller than or equal to 255.');
        }
    ...
    public function setInn($inn)
    {
        ...
        if ((mb_strlen($inn) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inn when calling Employee., must be smaller than or equal to 255.');
        }
    ...
    public function setPosition($position)
    {
        ...
        if ((mb_strlen($position) > 255)) {
            throw new \InvalidArgumentException('invalid length for $position when calling Employee., must be smaller than or equal to 255.');
        }
    ...
    public function setUid($uid)
    {
        ...
        if ((mb_strlen($uid) > 255)) {
            throw new \InvalidArgumentException('invalid length for $uid when calling Employee., must be smaller than or equal to 255.');
        }
