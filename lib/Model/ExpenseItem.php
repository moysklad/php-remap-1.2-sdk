 ...
 */
class ExpenseItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpenseItem';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID статьи расхода
     *
     * @return self
     */
