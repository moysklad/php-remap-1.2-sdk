...
/**
 * InternalOrderPosition Class Doc Comment
 *
 * @category Class
 * @description Позиция Внутреннего заказа
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InternalOrderPosition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InternalOrderPosition';
