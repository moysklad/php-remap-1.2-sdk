...
/**
 * MinimumStockAllWarehouseSum Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class MinimumStockAllWarehouseSum extends MinimumStockAbstract
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MinimumStockAllWarehouseSum';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling MinimumStockAllWarehouseSum., must be bigger than or equal to 0.');
        }
