...
/**
 * NotesAuthor Class Doc Comment
 *
 * @category Class
 * @description Метаданные Сотрудника - создателя события
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NotesAuthor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'notes_author';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NotesAuthor., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling NotesAuthor., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling NotesAuthor., must be smaller than or equal to 4096.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling NotesAuthor., must be smaller than or equal to 255.');
        }
    ...
    public function setMiddleName($middle_name)
    {
        ...
        if ((mb_strlen($middle_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling NotesAuthor., must be smaller than or equal to 255.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling NotesAuthor., must be smaller than or equal to 255.');
        }
    ...
    public function setInn($inn)
    {
        ...
        if ((mb_strlen($inn) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inn when calling NotesAuthor., must be smaller than or equal to 255.');
        }
    ...
    public function setPosition($position)
    {
        ...
        if ((mb_strlen($position) > 255)) {
            throw new \InvalidArgumentException('invalid length for $position when calling NotesAuthor., must be smaller than or equal to 255.');
        }
    ...
    public function setUid($uid)
    {
        ...
        if ((mb_strlen($uid) > 255)) {
            throw new \InvalidArgumentException('invalid length for $uid when calling NotesAuthor., must be smaller than or equal to 255.');
        }
