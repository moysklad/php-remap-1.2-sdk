...
class Prepayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID Предоплаты
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Наименование Предоплаты
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Prepayment., must be smaller than or equal to 255.');
        }
     ...
     * Sets code
     *
     * @param string|null $code Код Предоплаты
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Prepayment., must be smaller than or equal to 255.');
        }
     ...
     * Sets external_code
     *
     * @param string|null $external_code Внешний код Предоплаты
     *
     * @return self
     */
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling Prepayment., must be smaller than or equal to 255.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Комментарий Предоплаты
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Prepayment., must be smaller than or equal to 4096.');
        }
     ...
     * Sets deleted
     *
     * @param string|null $deleted Момент последнего удаления Предоплаты
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param string|null $updated Момент последнего обновления Предоплаты
     *
     * @return self
     */
