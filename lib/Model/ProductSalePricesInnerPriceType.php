<?php
/**
 * ProductSalePricesInnerPriceType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ProductSalePricesInnerPriceType Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductSalePricesInnerPriceType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'product_salePrices_inner_priceType';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductSalePricesInnerPriceType., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling ProductSalePricesInnerPriceType., must be smaller than or equal to 255.');
        }
