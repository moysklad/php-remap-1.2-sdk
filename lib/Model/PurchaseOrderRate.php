...
/**
 * PurchaseOrderRate Class Doc Comment
 *
 * @category Class
 * @description Валюта
 * @package  OpenAPI\Client
 ...
 */
class PurchaseOrderRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PurchaseOrder_rate';
