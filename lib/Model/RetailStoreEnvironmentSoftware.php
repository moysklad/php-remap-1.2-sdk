...
/**
 * RetailStoreEnvironmentSoftware Class Doc Comment
 *
 * @category Class
 ...
 */
class RetailStoreEnvironmentSoftware implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RetailStore_environment_software';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RetailStoreEnvironmentSoftware., must be smaller than or equal to 255.');
        }
    ...
    public function setVendor($vendor)
    {
        ...
        if ((mb_strlen($vendor) > 255)) {
            throw new \InvalidArgumentException('invalid length for $vendor when calling RetailStoreEnvironmentSoftware., must be smaller than or equal to 255.');
        }
    ...
    public function setVersion($version)
    {
        ...
        if ((mb_strlen($version) > 255)) {
            throw new \InvalidArgumentException('invalid length for $version when calling RetailStoreEnvironmentSoftware., must be smaller than or equal to 255.');
        }
