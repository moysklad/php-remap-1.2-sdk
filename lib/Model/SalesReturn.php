...
/**
 * SalesReturn Class Doc Comment
 *
 * @category Class
 * @description Возврат покупателя (salesreturn). Заглушка: полное описание сущности в спецификации отсутствует; в ответе API возможны дополнительные поля.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SalesReturn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesReturn';
