...
class Status implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        'sync' => 'sync',
        'last_check_moment' => 'lastCheckMoment',
    ...
    protected static $setters = [
        'sync' => 'setSync',
        'last_check_moment' => 'setLastCheckMoment',
    ...
    protected static $getters = [
        'sync' => 'getSync',
        'last_check_moment' => 'getLastCheckMoment',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('last_check_moment', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['last_check_moment'];
    }
     ...
     * @return self
     */
    public function setLastCheckMoment($last_check_moment)
    {
        if (is_null($last_check_moment)) {
            throw new \InvalidArgumentException('non-nullable last_check_moment cannot be null');
        }
        $this->container['last_check_moment'] = $last_check_moment;
