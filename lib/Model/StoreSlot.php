...
/**
 * StoreSlot Class Doc Comment
 *
 * @category Class
 * @description Ячейка склада
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class StoreSlot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreSlot';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StoreSlot., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalCode($external_code)
    {
        ...
        if ((mb_strlen($external_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_code when calling StoreSlot., must be smaller than or equal to 255.');
        }
    ...
    public function setBarcode($barcode)
    {
        ...
        if ((mb_strlen($barcode) > 255)) {
            throw new \InvalidArgumentException('invalid length for $barcode when calling StoreSlot., must be smaller than or equal to 255.');
        }
