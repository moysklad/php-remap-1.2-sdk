 ...
 */
class Thing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID Серийного номера
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Значение серийного номера
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Thing., must be smaller than or equal to 255.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Комментарий к серийному номеру
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Thing., must be smaller than or equal to 4096.');
        }
