...
/**
 * VariantCharacteristic Class Doc Comment
 *
 * @category Class
 * @description Характеристики модификаций
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class VariantCharacteristic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariantCharacteristic';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VariantCharacteristic., must be smaller than or equal to 255.');
        }
     ...
     * Sets required
     *
     * @param bool|null $required Обязательность указания Характеристики в модификации
     *
     * @return self
     */
