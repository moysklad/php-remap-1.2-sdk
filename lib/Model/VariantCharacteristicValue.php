...
/**
 * VariantCharacteristicValue Class Doc Comment
 *
 * @category Class
 * @description Значение характеристики модификаций
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class VariantCharacteristicValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariantCharacteristicValue';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID соответствующей Характеристики
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VariantCharacteristicValue., must be smaller than or equal to 255.');
        }
     ...
     * Sets value
     *
     * @param string|null $value Значение Характеристики
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling VariantCharacteristicValue., must be smaller than or equal to 255.');
        }
