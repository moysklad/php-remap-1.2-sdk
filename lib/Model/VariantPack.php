...
/**
 * VariantPack Class Doc Comment
 *
 * @category Class
 * @description Упаковка модификации
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class VariantPack implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VariantPack';
    ...
    protected static $openAPITypes = [
        ...
        'parentpack' => '\OpenAPI\Client\Model\Pack'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('parentpack', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets barcodes
     *
     * @param \OpenAPI\Client\Model\Barcode[]|null $barcodes Штрихкоды упаковки модификации
     *
     * @return self
     */
     ...
     */
    public function getParentpack()
    {
        return $this->container['parentpack'];
    }

    /**
     * Sets parentpack
     *
     * @param \OpenAPI\Client\Model\Pack|null $parentpack parentpack
     *
     * @return self
     */
    public function setParentpack($parentpack)
    {
        if (is_null($parentpack)) {
            throw new \InvalidArgumentException('non-nullable parentpack cannot be null');
        }
        $this->container['parentpack'] = $parentpack;
