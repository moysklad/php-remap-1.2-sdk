...
use OpenAPI\Client\Model\AttributeBool;
use OpenAPI\Client\Test\Utils\Asserter;
use PHPUnit\Framework\TestCase;

/**
 * AttributeBoolTest Class Doc Comment
 *
 * @category    Class
 * @description AttributeBool
 * @package     OpenAPI\Client
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class AttributeBoolTest extends TestCase
{

    public function testPropertyType()
    {
        $attribute = new AttributeBool();
        $attribute->setType(AttributeBool::TYPE_BOOLEAN);
        Asserter::assertJsonHasFields($attribute, ['type' => AttributeBool::TYPE_BOOLEAN]);
    }
    ...
    public function testPropertyValue()
    {
        ...
        Asserter::assertJsonHasFields($attribute, ['value' => true]);
    }
}
