...
/**
 * AttributeDoubleTest Class Doc Comment
 *
 * @category    Class
 * @description AttributeDouble
 * @package     OpenAPI\Client
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class AttributeDoubleTest extends TestCase
{

    public function testPropertyType()
    {
        $attribute = new AttributeDouble();
        $attribute->setType(AttributeDouble::TYPE_DOUBLE);
        Asserter::assertJsonHasFields($attribute, ['type' => AttributeDouble::TYPE_DOUBLE]);
    }
