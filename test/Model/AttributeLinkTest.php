...
use OpenAPI\Client\Model\AttributeLink;
use OpenAPI\Client\Test\Utils\Asserter;
use PHPUnit\Framework\TestCase;

/**
 * AttributeLinkTest Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://openapi-generator.tech
 */
class AttributeLinkTest extends TestCase
{

    public function testPropertyType()
    {
        $attribute = new AttributeLink();
        $attribute->setType(AttributeLink::TYPE_LINK);
        Asserter::assertJsonHasFields($attribute, ['type' => AttributeLink::TYPE_LINK]);
    }
