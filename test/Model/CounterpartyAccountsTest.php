...
/**
 * CounterpartyAccountsTest Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://openapi-generator.tech
 */
class CounterpartyAccountsTest extends TestCase
{

    public function testPropertyMeta()
    {
        $counterpartyAccounts = new CounterpartyAccounts();
        $meta = new MetaList();
        $counterpartyAccounts->setMeta($meta);
        Asserter::assertJsonHasFields($counterpartyAccounts, ['meta' => []]);
    }
    ...
    public function testPropertyRows()
    {
        $counterpartyAccounts = new CounterpartyAccounts();
        $rows = [];
        $counterpartyAccounts->setRows($rows);
        Asserter::assertJsonHasFields($counterpartyAccounts, ['rows' => []]);
    }
}
