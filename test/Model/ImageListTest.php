...
/**
 * ImageListTest Class Doc Comment
 *
 * @category    Class
...
class ImageListTest extends TestCase
{
    ...
    public function testPropertyMeta()
    {
        ...
        $meta = new MetaList();
        $imageList->setMeta($meta);
        Asserter::assertJsonHasFields($imageList, ['meta' => []]);
    }
    ...
    public function testPropertyRows()
    {
        $imageList = new ImageList();
        $rows = [];
        $imageList->setRows($rows);
        Asserter::assertJsonHasFields($imageList, ['rows' => []]);
    }
}
