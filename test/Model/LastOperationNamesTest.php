...
/**
 * LastOperationNamesTest Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://openapi-generator.tech
 */
class LastOperationNamesTest extends TestCase
{
    ...
    public function testPropertyEntity()
    {
        ...
        $entity = "product";
        $lastOperationNames->setEntity($entity);
        Asserter::assertJsonHasFields($lastOperationNames, ['entity' => $entity]);
    }
    ...
    public function testPropertyName()
    {
        $lastOperationNames = new LastOperationNames();
        $name = "Last Sale";
        $lastOperationNames->setName($name);
        Asserter::assertJsonHasFields($lastOperationNames, ['name' => $name]);
    }
}
