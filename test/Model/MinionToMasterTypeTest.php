...
/**
 * MinionToMasterTypeTest Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://openapi-generator.tech
 */
class MinionToMasterTypeTest extends TestCase
{

    public function testMinionToMasterType()
    {
        $this->assertEquals(MinionToMasterType::ANY, 'ANY');
        $this->assertEquals(MinionToMasterType::SAME_GROUP, 'SAME_GROUP');
        $this->assertEquals(MinionToMasterType::CHOSEN, 'CHOSEN');
    }
}
