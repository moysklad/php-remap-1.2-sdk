...
/**
 * PaymentTerminalTest Class Doc Comment
 *
 * @category    Class
...
class PaymentTerminalTest extends TestCase
{
    ...
    public function testPropertyAcquiringType()
    {
        ...
        $acquiringType = "BANK_CARD";
        $paymentTerminal->setAcquiringType($acquiringType);
        Asserter::assertJsonHasFields($paymentTerminal, ['acquiringType' => $acquiringType]);
    }
}
