...
/**
 * PriorityOfdSendTest Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://openapi-generator.tech
 */
class PriorityOfdSendTest extends TestCase
{

    public function testPriorityOfdSend()
    {
        $this->assertEquals(PriorityOfdSend::PHONE, 'phone');
        $this->assertEquals(PriorityOfdSend::EMAIL, 'email');
        $this->assertEquals(PriorityOfdSend::NONE, 'none');
    }
}
