<?php
/**
 * RetailStoreCreateOrderWithStateTest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RetailStoreCreateOrderWithStateTest Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://openapi-generator.tech
 */
class RetailStoreCreateOrderWithStateTest extends TestCase
{

    public function testPropertyMeta()
    {
        $retailStoreCreateOrderWithState = new RetailStoreCreateOrderWithState();
        $meta = new Meta();
        $retailStoreCreateOrderWithState->setMeta($meta);
        Asserter::assertJsonHasFields($retailStoreCreateOrderWithState, ['meta' => []]);
    }
}
