<?php
/**
 * RetailStoreCustomerOrderStatesInnerTest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RetailStoreCustomerOrderStatesInnerTest Class Doc Comment
 *
 * @category    Class
 * @description RetailStoreCustomerOrderStatesInner
 * @package     OpenAPI\Client
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class RetailStoreCustomerOrderStatesInnerTest extends TestCase
{

    public function testPropertyMeta()
    {
        $retailStoreCustomerOrderStatesInner = new RetailStoreCustomerOrderStatesInner();
        $meta = new Meta();
        $retailStoreCustomerOrderStatesInner->setMeta($meta);
        Asserter::assertJsonHasFields($retailStoreCustomerOrderStatesInner, ['meta' => []]);
    }
}
