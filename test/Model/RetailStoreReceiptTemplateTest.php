<?php
/**
 * RetailStoreReceiptTemplateTest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RetailStoreReceiptTemplateTest Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://openapi-generator.tech
 */
class RetailStoreReceiptTemplateTest extends TestCase
{

    public function testPropertyMeta()
    {
        $retailStoreReceiptTemplate = new RetailStoreReceiptTemplate();
        $meta = new Meta();
        $retailStoreReceiptTemplate->setMeta($meta);
        Asserter::assertJsonHasFields($retailStoreReceiptTemplate, ['meta' => []]);
    }
}
